...
// --- 'formularioLogin' desde el controlador unificado ---
import { formularioLogin } from './controllers/adminController.js';

// Importaciones de Rutas
import dashboardRoutes from './routes/dashboardRoutes.js';
import adminRoutes from './routes/adminRoutes.js'; // Este ahora maneja todo lo de usuarios
...
// --- ¡CORRECCIÓN! Se unifican las rutas de usuarios ---
// La línea app.use('/', adminRoutes) ahora maneja /auth/login, /auth/logout, /admin/usuarios, etc.
app.use('/', adminRoutes); 
